...
Architecture scaffold only. No application runtime has been implemented yet. Paths marked **planned** are reserved implementation boundaries, not working modules.
